...
-spec add(Record :: tuple())                -> {ok, tuple()} | {error, exist | no_container | just_added} | {aborted,any()}.
-spec link(Record :: tuple())               -> {ok, tuple()} | {error, not_found | no_container | just_added}.
...
-spec get(Tab :: atom(), Key :: any())                      -> {ok, any()} | {error, duplicated | not_found}.
-spec get(Tab :: atom(), Key :: any(), Value :: any())      -> {ok, any()} | {error, duplicated | not_found}.
